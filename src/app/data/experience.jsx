const experience = [
  {
    id: 1,
    src: '/images/company/gsgrupo.png',
    puesto: 'Senior Full-Stack Developer',
    empresa: "Grupo G's",
    fechas: 'Febrero 2024 - Presente',
    content: (
      <ul className="list-disc space-y-2 ml-5 text-s">
        <li>Desarrollo de front-end Angular 17</li>
  ...
  },
  {
    ...
    puesto: 'Senior Full-Stack Developer',
    empresa: 'Capgemini',
    fechas: 'Julio 2021 - Febrero 2024',
    content: (
      <ul className="list-disc space-y-2 ml-5 text-s">
        <li>Desarrollo backend con Java 11 y Spring Batch</li>
        <li>
          Análisis de requisitos para una aplicación refactorizada (Java) en
          base a los casos de uso de la aplicación origen (CA Plex)
        </li>
